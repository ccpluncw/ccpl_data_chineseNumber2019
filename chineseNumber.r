...
###Mixed Model analysis
  ...
  with(outDF[outDF$set=='chi-arb',], boxplot(Wel, PSa, PSc, ylim=c(-.11,.11), names=c("Welford","PS Arabic","PS Chinese"), main="Chinese - Arabic"))
  abline(0,0,col=rgb(.5,.5,.5))

  with(outDF[outDF$set=='chi-chi',], boxplot(Wel, PSa, PSc, ylim=c(-.11,.11), names=c("Welford","PS Arabic","PS Chinese"), main="Chinese - Chinese "))
  abline(0,0,col=rgb(.5,.5,.5))
